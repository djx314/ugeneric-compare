...
trait PeUserTable {
  ...
  case class PeUserRow(userid: Int = 0, groupid: Option[Int], clientid: Option[Int] = Some(0), contacterid: Option[Int] = Some(0), companyid: Option[Int] = Some(0), usertype: Option[Int] = Some(0), username: Option[String], userpassword: Option[String], lastpassword: Option[String], question: Option[String], answer: Option[String], email: Option[String], userface: Option[String], facewidth: Option[Short], faceheight: Option[Short], sign: Option[String], regtime: Option[java.sql.Timestamp], jointime: Option[java.sql.Timestamp], lastlogintime: Option[java.sql.Timestamp], lastpresenttime: Option[java.sql.Timestamp], lastloginip: Option[String], balance: Option[scala.math.BigDecimal], userpoint: Option[Int], userexp: Option[Int], consumepoint: Option[Int], postitems: Option[Int], passeditems: Option[Int], delitems: Option[Int], unsigneditems: Option[String], unreadmsg: Option[Short], begintime: Option[java.sql.Timestamp], validnum: Option[Short], validunit: Option[Short], islocked: Option[Boolean], specialpermission: Option[Boolean], arrclassBrowse: Option[String], arrclassView: Option[String], arrclassInput: Option[String], privacy: Option[Short], userfriendgroup: Option[String], usersetting: Option[String], checknum: Option[Int] = Some(0), blog: Option[Boolean], logintimes: Option[Int])
  ...
  class PeUser(_tableTag: Tag) extends profile.api.Table[PeUserRow](_tableTag, "PE_User") {
    ...
    val index1 = index("PE_USER_CHECKNUM", checknum)
    /** Index over (clientid) (database name PE_USER_CLIENTID) */
    val index2 = index("PE_USER_CLIENTID", clientid)
    /** Index over (companyid) (database name PE_USER_COMPANYID) */
    val index3 = index("PE_USER_COMPANYID", companyid)
    /** Index over (contacterid) (database name PE_USER_CONTACTERID) */
    val index4 = index("PE_USER_CONTACTERID", contacterid)
    /** Index over (groupid) (database name PE_USER_USERGROUPID) */
    val index5 = index("PE_USER_USERGROUPID", groupid)
    /** Index over (validnum) (database name PE_USER_VALIDNUM) */
    val index6 = index("PE_USER_VALIDNUM", validnum)
  }
