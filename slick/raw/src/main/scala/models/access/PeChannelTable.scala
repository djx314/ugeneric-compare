...
trait PeChannelTable {
  ...
  case class PeChannelRow(channelid: Int = 0, channelname: String, channelshortname: Option[String], channelitemunit: Option[String], readme: Option[String], metaKeywords: Option[String], metaDescription: Option[String], channelpicurl: Option[String], orderid: Int, opentype: Int, channeltype: Int, linkurl: Option[String], channeldir: Option[String], moduletype: Option[Int], disabled: Boolean, showname: Boolean, shownameonpath: Option[Boolean], showclasstreeguide: Boolean, showsuspensionpoints: Option[Boolean], checklevel: Int = 0, enableuploadfile: Boolean, uploaddir: Option[String], maxfilesize: Option[Int], hitsofhot: Option[Int], daysofnew: Option[Int], maxperline: Option[Int], upfiletype: Option[String], defaultskinid: Option[Int], templateIndex: Option[Int], topmenutype: Option[Int], classguidetype: Option[Int], usecreatehtml: Int = 0, itemcount: Option[Int], itemchecked: Option[Int], commentcount: Option[Int], specialcount: Option[Int], hitscount: Option[Int], structuretype: Option[Int] = Some(0), listfiletype: Option[Int] = Some(0), filenametype: Option[Int] = Some(0), autocreatetype: Option[Int] = Some(0), fileextIndex: Option[Int] = Some(0), fileextList: Option[Int] = Some(0), fileextItem: Option[Int] = Some(0), updatepages: Option[Int] = Some(0), channelpurview: Option[Int] = Some(0), arrgroupid: Option[String], jsSpecialnum: Option[Int] = Some(0), authorinfolen: Option[Int] = Some(0), maxperpageIndex: Option[Int] = Some(0), maxperpageSearchresult: Option[Int] = Some(0), maxperpageNew: Option[Int] = Some(0), maxperpageHot: Option[Int] = Some(0), maxperpageElite: Option[Int] = Some(0), maxperpageSpeciallist: Option[Int] = Some(0), moneyperkw: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), timingcreatesetting: Option[String], emailofreject: Option[String], emailofpassed: Option[String], customContent: Option[String], arrenabledtabs: Option[String], commandchannelpoint: Option[Int], fieldsOptions: Option[String], enablecomment: Option[Boolean], checkcomment: Option[Boolean])
  ...
  class PeChannel(_tableTag: Tag) extends profile.api.Table[PeChannelRow](_tableTag, "PE_Channel") {
    def * = (channelid :: channelname :: channelshortname :: channelitemunit :: readme :: metaKeywords :: metaDescription :: channelpicurl :: orderid :: opentype :: channeltype :: linkurl :: channeldir :: moduletype :: disabled :: showname :: shownameonpath :: showclasstreeguide :: showsuspensionpoints :: checklevel :: enableuploadfile :: uploaddir :: maxfilesize :: hitsofhot :: daysofnew :: maxperline :: upfiletype :: defaultskinid :: templateIndex :: topmenutype :: classguidetype :: usecreatehtml :: itemcount :: itemchecked :: commentcount :: specialcount :: hitscount :: structuretype :: listfiletype :: filenametype :: autocreatetype :: fileextIndex :: fileextList :: fileextItem :: updatepages :: channelpurview :: arrgroupid :: jsSpecialnum :: authorinfolen :: maxperpageIndex :: maxperpageSearchresult :: maxperpageNew :: maxperpageHot :: maxperpageElite :: maxperpageSpeciallist :: moneyperkw :: timingcreatesetting :: emailofreject :: emailofpassed :: customContent :: arrenabledtabs :: commandchannelpoint :: fieldsOptions :: enablecomment :: checkcomment :: HNil).mapTo[PeChannelRow]
    ...
    val index1 = index("PE_CHANNEL_ARRGROUPID", arrgroupid :: HNil)
    /** Index over (defaultskinid) (database name PE_CHANNEL_DEFAULTSKINID) */
    val index2 = index("PE_CHANNEL_DEFAULTSKINID", defaultskinid :: HNil)
    /** Index over (disabled) (database name PE_CHANNEL_DISABLED) */
    val index3 = index("PE_CHANNEL_DISABLED", disabled :: HNil)
    /** Index over (orderid) (database name PE_CHANNEL_ORDERID) */
    val index4 = index("PE_CHANNEL_ORDERID", orderid :: HNil)
  }
