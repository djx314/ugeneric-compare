...
trait PeAdvertisementTable {
  ...
  case class PeAdvertisementRow(adid: Int, userid: Option[Int] = Some(0), zoneid: Option[String], adtype: Option[Int] = Some(0), adname: Option[String], imgurl: Option[String], imgwidth: Option[Int], imgheight: Option[Int], flashwmode: Option[Int] = Some(0), adintro: Option[String], linkurl: Option[String], linktarget: Option[Int] = Some(0), linkalt: Option[String], priority: Option[String], setting: Option[String], countview: Option[Boolean], views: Option[Int] = Some(0), countclick: Option[Boolean], clicks: Option[Int] = Some(0), passed: Option[Boolean])
  ...
  class PeAdvertisement(_tableTag: Tag) extends profile.api.Table[PeAdvertisementRow](_tableTag, "PE_Advertisement") {
    def * = (adid :: userid :: zoneid :: adtype :: adname :: imgurl :: imgwidth :: imgheight :: flashwmode :: adintro :: linkurl :: linktarget :: linkalt :: priority :: setting :: countview :: views :: countclick :: clicks :: passed :: HNil).mapTo[PeAdvertisementRow]
    ...
    val index1 = index("PE_ADVERTISEMENT_ADTYPE", adtype :: HNil)
  }
