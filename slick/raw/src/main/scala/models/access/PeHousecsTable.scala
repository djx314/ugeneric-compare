...
trait PeHousecsTable {
  ...
  class PeHousecs(_tableTag: Tag) extends profile.api.Table[PeHousecsRow](_tableTag, "PE_HouseCS") {
    def * = (houseid :: classid :: channelid :: housesource :: housequyu :: housedizhi :: housexiangxidizhi :: househuxing :: housemianji :: housechanquan :: housejiancheng :: houselouceng :: housechaoxiang :: houseleixing :: housejichu :: housezhuangxiu :: houseshuidian :: housedianqi :: housejiaju :: housegongjiaolu :: housegongjiaozhan :: houseshizheng :: jiaofangstartdate :: totalprice :: otherprice :: housezhifu :: housepricetype :: shuifei :: contactname :: contactphone :: contactemail :: contactqq :: keyword :: youxiaoqi :: houseqita :: editor :: updatetime :: hits :: viewall :: hot :: ontop :: elite :: passed :: deleted :: commendclassdays :: uploadphotos :: HNil).mapTo[PeHousecsRow]
