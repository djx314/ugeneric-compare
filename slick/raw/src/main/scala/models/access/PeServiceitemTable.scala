...
trait PeServiceitemTable {
  ...
  class PeServiceitem(_tableTag: Tag) extends profile.api.Table[PeServiceitemRow](_tableTag, "PE_ServiceItem") {
    def * = (itemid :: clientid :: contacterid :: orderformid :: servicetime :: servicetype :: servicemode :: servicetitle :: servicecontent :: serviceresult :: taketime :: processor :: inputer :: feedback :: confirmtime :: confirmcaller :: confirmscore :: confirmfeedback :: remark :: HNil).mapTo[PeServiceitemRow]
