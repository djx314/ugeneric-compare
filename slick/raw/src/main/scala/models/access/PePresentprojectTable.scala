...
trait PePresentprojectTable {
  ...
  class PePresentproject(_tableTag: Tag) extends profile.api.Table[PePresentprojectRow](_tableTag, "PE_PresentProject") {
    def * = (projectid :: projectname :: begindate :: enddate :: minmoney :: maxmoney :: presentcontent :: price :: presentid :: cash :: presentexp :: presentpoint :: HNil).mapTo[PePresentprojectRow]
