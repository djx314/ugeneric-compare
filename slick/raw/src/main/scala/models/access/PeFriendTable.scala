...
trait PeFriendTable {
  ...
  class PeFriend(_tableTag: Tag) extends profile.api.Table[PeFriendRow](_tableTag, "PE_Friend") {
    def * = (id :: username :: friendname :: addtime :: groupid :: HNil).mapTo[PeFriendRow]
    ...
    val index1 = index("PE_FRIEND_GROUPID", groupid :: HNil)
    /** Index over (addtime) (database name PE_FRIEND_ORDERID) */
    val index2 = index("PE_FRIEND_ORDERID", addtime :: HNil)
  }
