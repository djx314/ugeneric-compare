...
trait PeMessageTable {
  ...
  case class PeMessageRow(id: Int, sender: Option[String], incept: Option[String], title: Option[String], content: Option[String], flag: Option[Int] = Some(0), sendtime: Option[java.sql.Timestamp], delr: Int = 0, dels: Int = 0, issend: Option[Int] = Some(0))
  ...
  class PeMessage(_tableTag: Tag) extends profile.api.Table[PeMessageRow](_tableTag, "PE_Message") {
    def * = (id :: sender :: incept :: title :: content :: flag :: sendtime :: delr :: dels :: issend :: HNil).mapTo[PeMessageRow]
