...
trait PeFriendsiteTable {
  ...
  class PeFriendsite(_tableTag: Tag) extends profile.api.Table[PeFriendsiteRow](_tableTag, "PE_FriendSite") {
    def * = (id :: kindid :: specialid :: linktype :: sitename :: siteurl :: siteintro :: logourl :: siteadmin :: siteemail :: sitepassword :: stars :: hits :: updatetime :: elite :: passed :: orderid :: HNil).mapTo[PeFriendsiteRow]
