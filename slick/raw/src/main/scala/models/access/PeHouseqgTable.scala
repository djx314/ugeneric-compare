...
trait PeHouseqgTable {
  ...
  case class PeHouseqgRow(houseid: Int = 0, classid: Option[Int] = Some(3), channelid: Option[Int] = Some(998), housesource: Option[String], housequyu: Option[String], housedizhi: Option[String], housejiancheng1: Option[String], housejiancheng2: Option[String], houseleixing: Option[String], housexingzhi: Option[String], househuxing: Option[String], housemianji1: scala.math.BigDecimal = scala.math.BigDecimal("0"), housemianji2: scala.math.BigDecimal = scala.math.BigDecimal("0"), houselouceng: Option[String], housechaoxiang: Option[String], housepricetype: Option[String], houseprice1: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), houseprice2: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), housezhifu: Option[String], housejichu: Option[String], housezhuangxiu: Option[String], houseshizheng: Option[String], jiaofangstartdate: Option[java.sql.Timestamp], contactname: String, contactphone: String, contactemail: Option[String], contactqq: Option[String], keyword: String, youxiaoqi: Option[String], houseqita: Option[String], editor: Option[String], updatetime: Option[java.sql.Timestamp], viewall: Option[Boolean], hits: Option[Int] = Some(0), hot: Option[Boolean], ontop: Option[Boolean], elite: Option[Boolean], passed: Option[Boolean], deleted: Boolean, commendclassdays: Option[Int] = Some(0), uploadphotos: Option[String])
