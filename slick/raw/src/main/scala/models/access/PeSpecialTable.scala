...
trait PeSpecialTable {
  ...
  class PeSpecial(_tableTag: Tag) extends profile.api.Table[PeSpecialRow](_tableTag, "PE_Special") {
    def * = (specialid :: channelid :: specialname :: opentype :: specialpicurl :: orderid :: tips :: readme :: skinid :: templateid :: specialdir :: maxperpage :: iselite :: customContent :: HNil).mapTo[PeSpecialRow]
