...
trait PeOrderformitemTable {
  ...
  case class PeOrderformitemRow(itemid: Int = 0, orderformid: Option[Int] = Some(0), productid: Option[Int] = Some(0), saletype: Option[Int] = Some(0), priceOriginal: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), price: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), trueprice: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), amount: Option[Int] = Some(0), subtotal: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), begindate: Option[java.sql.Timestamp], serviceterm: Option[Int] = Some(0), remark: Option[String], presentmoney: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), presentpoint: Option[Int] = Some(0), presentexp: Option[Int] = Some(0))
  ...
  class PeOrderformitem(_tableTag: Tag) extends profile.api.Table[PeOrderformitemRow](_tableTag, "PE_OrderFormItem") {
    def * = (itemid :: orderformid :: productid :: saletype :: priceOriginal :: price :: trueprice :: amount :: subtotal :: begindate :: serviceterm :: remark :: presentmoney :: presentpoint :: presentexp :: HNil).mapTo[PeOrderformitemRow]
