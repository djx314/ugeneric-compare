...
trait PeSoftTable {
  ...
  case class PeSoftRow(softid: Int, channelid: Int, classid: Int, softname: String, softversion: Option[String], author: Option[String], copyfrom: Option[String], demourl: Option[String], inputer: Option[String], editor: Option[String], keyword: String, hits: Option[Int], dayhits: Option[Int], weekhits: Option[Int], monthhits: Option[Int], commentcount: Option[Int] = Some(0), updatetime: Option[java.sql.Timestamp], createtime: Option[java.sql.Timestamp], operatingsystem: Option[String], softtype: Option[String], softlanguage: Option[String], copyrighttype: Option[String], softsize: Option[Int], regurl: Option[String], ontop: Boolean, elite: Boolean, status: Int = 0, softintro: Option[String], softpicurl: Option[String], downloadurl: Option[String], infopoint: Option[Int], deleted: Boolean, stars: Option[Int], decompresspassword: Option[String], lasthittime: Option[java.sql.Timestamp], templateid: Option[Int], skinid: Option[Int], errortimes: Option[Int] = Some(0), voteid: Option[Int] = Some(0), presentexp: Option[Double] = Some(0.0), browsetimes: Option[Int] = Some(0), infopurview: Option[Int] = Some(0), arrgroupid: Option[String], chargetype: Option[Int] = Some(0), pitchtime: Option[Int] = Some(0), readtimes: Option[Int] = Some(0), dividepercent: Option[Int] = Some(0), blogid: Option[Int] = Some(0))
  ...
  class PeSoft(_tableTag: Tag) extends profile.api.Table[PeSoftRow](_tableTag, "PE_Soft") {
    def * = (softid :: channelid :: classid :: softname :: softversion :: author :: copyfrom :: demourl :: inputer :: editor :: keyword :: hits :: dayhits :: weekhits :: monthhits :: commentcount :: updatetime :: createtime :: operatingsystem :: softtype :: softlanguage :: copyrighttype :: softsize :: regurl :: ontop :: elite :: status :: softintro :: softpicurl :: downloadurl :: infopoint :: deleted :: stars :: decompresspassword :: lasthittime :: templateid :: skinid :: errortimes :: voteid :: presentexp :: browsetimes :: infopurview :: arrgroupid :: chargetype :: pitchtime :: readtimes :: dividepercent :: blogid :: HNil).mapTo[PeSoftRow]
    ...
    val index1 = index("PE_SOFT_AUTHOR", author :: HNil)
    /** Index over (channelid) (database name PE_SOFT_CHANNELID) */
    val index2 = index("PE_SOFT_CHANNELID", channelid :: HNil)
    /** Index over (classid) (database name PE_SOFT_CLASSID) */
    val index3 = index("PE_SOFT_CLASSID", classid :: HNil)
    /** Index over (inputer) (database name PE_SOFT_INPUTER) */
    val index4 = index("PE_SOFT_INPUTER", inputer :: HNil)
    /** Index over (keyword) (database name PE_SOFT_KEYWORD) */
    val index5 = index("PE_SOFT_KEYWORD", keyword :: HNil)
    /** Index over (skinid) (database name PE_SOFT_SKINID) */
    val index6 = index("PE_SOFT_SKINID", skinid :: HNil)
    /** Index over (status) (database name PE_SOFT_STATUS) */
    val index7 = index("PE_SOFT_STATUS", status :: HNil)
    /** Index over (templateid) (database name PE_SOFT_TEMPLATEID) */
    val index8 = index("PE_SOFT_TEMPLATEID", templateid :: HNil)
    /** Index over (updatetime) (database name PE_SOFT_UPDATETIME) */
    val index9 = index("PE_SOFT_UPDATETIME", updatetime :: HNil)
  }
