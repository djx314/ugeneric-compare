...
trait PeAreacollectionTable {
  ...
  case class PeAreacollectionRow(areaid: Int, areaname: Option[String], areafile: Option[String], areaintro: Option[String], code: Option[Int] = Some(0), stringreplace: Option[String], areaurl: Option[String], lablestart: Option[String], lableend: Option[String], filterproperty: Option[String], upfiletype: Option[String], areapassed: Option[Boolean], `type`: Option[Short] = Some(0))
  ...
  class PeAreacollection(_tableTag: Tag) extends profile.api.Table[PeAreacollectionRow](_tableTag, "PE_AreaCollection") {
    def * = (areaid :: areaname :: areafile :: areaintro :: code :: stringreplace :: areaurl :: lablestart :: lableend :: filterproperty :: upfiletype :: areapassed :: `type` :: HNil).mapTo[PeAreacollectionRow]
