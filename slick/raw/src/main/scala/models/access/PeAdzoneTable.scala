...
trait PeAdzoneTable {
  ...
  case class PeAdzoneRow(zoneid: Int = 0, channelid: Option[Int] = Some(0), includeadid: Option[String], zonename: Option[String], zonejsname: Option[String], zoneintro: Option[String], zonetype: Option[Int] = Some(0), defaultsetting: Option[Boolean], zonesetting: Option[String], zonewidth: Option[Int] = Some(0), zoneheight: Option[Int] = Some(0), active: Option[Boolean], showtype: Option[Int] = Some(0), updatetime: java.sql.Timestamp)
  ...
  class PeAdzone(_tableTag: Tag) extends profile.api.Table[PeAdzoneRow](_tableTag, "PE_AdZone") {
    def * = (zoneid :: channelid :: includeadid :: zonename :: zonejsname :: zoneintro :: zonetype :: defaultsetting :: zonesetting :: zonewidth :: zoneheight :: active :: showtype :: updatetime :: HNil).mapTo[PeAdzoneRow]
    ...
    val index1 = index("PE_ADZONE_CHANNELID", channelid :: HNil)
    /** Index over (zonetype) (database name PE_ADZONE_ZONETYPE) */
    val index2 = index("PE_ADZONE_ZONETYPE", zonetype :: HNil)
  }
