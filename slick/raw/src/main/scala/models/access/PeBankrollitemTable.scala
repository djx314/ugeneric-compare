...
trait PeBankrollitemTable {
  ...
  class PeBankrollitem(_tableTag: Tag) extends profile.api.Table[PeBankrollitemRow](_tableTag, "PE_BankrollItem") {
    def * = (itemid :: username :: clientid :: dateandtime :: money :: moneytype :: currencytype :: ebankid :: bank :: incomePayout :: orderformid :: paymentid :: remark :: logtime :: inputer :: ip :: HNil).mapTo[PeBankrollitemRow]
