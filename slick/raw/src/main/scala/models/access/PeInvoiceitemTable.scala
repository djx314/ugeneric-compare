...
trait PeInvoiceitemTable {
  ...
  class PeInvoiceitem(_tableTag: Tag) extends profile.api.Table[PeInvoiceitemRow](_tableTag, "PE_InvoiceItem") {
    def * = (invoiceid :: clientid :: username :: orderformid :: invoicetype :: invoicenum :: invoicetitle :: invoicecontent :: invoicedate :: totalmoney :: drawer :: inputer :: inputtime :: HNil).mapTo[PeInvoiceitemRow]
