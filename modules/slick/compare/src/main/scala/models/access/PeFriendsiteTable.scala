...
trait PeFriendsiteTable {
  ...
  case class PeFriendsiteRow(id: Int, kindid: Option[Int] = Some(0), specialid: Option[Int] = Some(0), linktype: Option[Int], sitename: Option[String], siteurl: Option[String], siteintro: Option[String], logourl: Option[String], siteadmin: Option[String], siteemail: Option[String], sitepassword: Option[String], stars: Option[Int], hits: Option[Int], updatetime: Option[java.sql.Timestamp], elite: Boolean, passed: Boolean, orderid: Int = 0)
