...
trait PeHousehzTable {
  ...
  case class PeHousehzRow(
    houseid: Int = 0,
    classid: Option[Int] = Some(5),
    channelid: Option[Int] = Some(998),
    housesource: Option[String],
    hezhutype: Option[String],
    ...
    househuxing1: Option[String],
    househuxing2: Option[String],
    ...
    housejianjie: Option[String],
    houseshiyou: Option[String],
    housejichu: Option[String],
    housezhuangxiu: Option[String],
    houseweisheng: Option[String],
    housedianqi: Option[String],
    housejiaju: Option[String],
    housexinxi: Option[String],
    housegongjiaolu: Option[String],
    housegongjiaozhan: Option[String],
    houseshizheng: Option[String],
    zulinstartdate: Option[java.sql.Timestamp],
    zulinenddate: Option[java.sql.Timestamp],
    housezujin: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    housezujintype: Option[String],
