...
trait PeArticleTable {
  ...
  case class PeArticleRow(
    articleid: Int,
    channelid: Int,
    classid: Int,
    title: String,
    titleintact: Option[String],
    ...
    content: String,
    includepic: Int = 0,
    defaultpicurl: Option[String],
    uploadfiles: Option[String],
    infopoint: Option[Int],
    paginationtype: Option[Int],
    deleted: Boolean,
    skinid: Option[Int],
    templateid: Option[Int],
    stars: Option[Int],
    titlefontcolor: Option[String],
    titlefonttype: Option[Int],
    maxcharperpage: Option[Int],
    showcommentlink: Boolean,
    receive: Option[Boolean],
    receiveuser: Option[String],
    received: Option[String],
    autoreceivetime: Option[Int] = Some(0),
    receivetype: Option[Int] = Some(0),
    intro: Option[String],
    presentexp: Option[Double] = Some(0.0),
    copymoney: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    ispayed: Option[Boolean],
    beneficiary: Option[String],
    paydate: Option[java.sql.Timestamp],
