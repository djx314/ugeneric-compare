...
trait PeHouseqzTable {
  ...
  case class PeHouseqzRow(
    houseid: Int = 0,
    classid: Option[Int] = Some(4),
    ...
    housezujin1: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    housezujin2: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
