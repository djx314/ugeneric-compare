...
trait PeDeliverchargeTable {
  ...
  case class PeDeliverchargeRow(id: Int, delivertypeid: Option[Int] = Some(0), areatype: Option[Int] = Some(0), arrarea: Option[String], chargeMin: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), weightMin: Option[Double] = Some(0.0), chargeperunit: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), weightperunit: Option[Double] = Some(0.0), chargeMax: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")))
  ...
  class PeDelivercharge(_tableTag: Tag) extends profile.api.Table[PeDeliverchargeRow](_tableTag, "PE_DeliverCharge") {
    ...
    val index1 = index("PE_DELIVERCHARGE_AREATYPE", areatype)
    /** Index over (delivertypeid) (database name PE_DELIVERCHARGE_DELIVERTYPEID) */
    val index2 = index("PE_DELIVERCHARGE_DELIVERTYPEID", delivertypeid)
  }
