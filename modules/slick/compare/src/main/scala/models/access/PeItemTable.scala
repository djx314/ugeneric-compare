...
trait PeItemTable {
  ...
  case class PeItemRow(itemid: Int, itemname: Option[String], channelid: Option[Int] = Some(0), classid: Option[Int] = Some(0), specialid: Option[String], webname: Option[String], weburl: Option[String], logintype: Option[Int] = Some(0), loginurl: Option[String], loginposturl: Option[String], loginuser: Option[String], loginpass: Option[String], loginfalse: Option[String], itemdoem: Option[String], liststr: Option[String], lsstring: Option[String], lostring: Option[String], listpaingtype: Option[Int] = Some(0), lpsstring: Option[String], lpostring: Option[String], listpaingstr1: Option[String], listpaingstr2: Option[String], listpaingid1: Option[Int] = Some(0), listpaingid2: Option[Int] = Some(0), listpaingstr3: Option[String], hsstring: Option[String], hostring: Option[String], httpurltype: Option[Int] = Some(0), httpurlstr: Option[String], thumbnailtype: Option[Int] = Some(0), thsstring: Option[String], thostring: Option[String], tsstring: Option[String], tostring: Option[String], csstring: Option[String], costring: Option[String], authortype: Option[Int] = Some(0), authorstr: Option[String], asstring: Option[String], aostring: Option[String], copyfromtype: Option[Int] = Some(0), fsstring: Option[String], fostring: Option[String], copyfromstr: Option[String], keytype: Option[Int] = Some(0), ksstring: Option[String], kostring: Option[String], keystr: Option[String], keyscatternum: Option[Int] = Some(2), newspaingtype: Option[Int] = Some(0), npsstring: Option[String], npostring: Option[String], newspaingstr1: Option[String], newspaingstr2: Option[String], flag: Option[Boolean], paginationtype: Option[Int] = Some(0), maxcharperpage: Option[Int] = Some(0), infopoint: Option[Int] = Some(0), ontop: Option[Boolean], hot: Option[Boolean], elite: Option[Boolean], hits: Int = 0, stars: Option[Int] = Some(0), updatetime: java.sql.Timestamp, skinid: Option[Int] = Some(0), templateid: Option[Int] = Some(0), scriptIframe: Option[Boolean], scriptObject: Option[Boolean], scriptScript: Option[Boolean], scriptDiv: Option[Boolean], scriptClass: Option[Boolean], scriptSpan: Option[Boolean], scriptImg: Option[Boolean], scriptFont: Option[Boolean], scriptA: Option[Boolean], scriptHtml: Option[Boolean], savefiles: Option[Boolean], addthumb: Option[Boolean], addwatermark: Option[Boolean], collecorder: Option[Int] = Some(0), status: Option[Int] = Some(0), createimmediate: Option[Boolean], includepicyn: Option[Boolean], defaultpicyn: Option[Boolean], newscollecdate: Option[java.sql.Timestamp], collectionnum: Option[String], collectiontype: Option[Int] = Some(0), updatetype: Option[Int], datetype: Option[Int], dsstring: Option[String], dostring: Option[String], showcommentlink: Option[Boolean], scriptTable: Option[Boolean], scriptTr: Option[Boolean], scriptTd: Option[Boolean], psstring: Option[String], postring: Option[String], phsstring: Option[String], phostring: Option[String], introtype: Option[Int] = Some(0), isstring: Option[String], iostring: Option[String], introstr: Option[String], intronum: Option[Int] = Some(0), isfield: Option[Int] = Some(0), field: Option[String], infopurview: Option[Int] = Some(0), arrgroupid: Option[String], chargetype: Option[Int] = Some(0), pitchtime: Option[Int] = Some(0), readtimes: Option[Int] = Some(0), dividepercent: Option[Int] = Some(0), saveflashurltofile: Option[Boolean])
  ...
  class PeItem(_tableTag: Tag) extends profile.api.Table[PeItemRow](_tableTag, "PE_Item") {
    ...
    val index1 = index("PE_ITEM_CHANNELID", channelid)
    /** Index over (classid) (database name PE_ITEM_CLASSID) */
    val index2 = index("PE_ITEM_CLASSID", classid)
    /** Index over (skinid) (database name PE_ITEM_SKINID) */
    val index3 = index("PE_ITEM_SKINID", skinid)
    /** Index over (specialid) (database name PE_ITEM_SPECIALID) */
    val index4 = index("PE_ITEM_SPECIALID", specialid)
    /** Index over (templateid) (database name PE_ITEM_TEMPLATEID) */
    val index5 = index("PE_ITEM_TEMPLATEID", templateid)
    /** Index over (updatetime) (database name PE_ITEM_UPDATETIME) */
    val index6 = index("PE_ITEM_UPDATETIME", updatetime)
  }
