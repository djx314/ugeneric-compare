...
trait PeSoftTable {
  ...
  class PeSoft(_tableTag: Tag) extends profile.api.Table[PeSoftRow](_tableTag, "PE_Soft") {
    def * =
      (softid :: channelid :: classid :: softname :: softversion :: author :: copyfrom :: demourl :: inputer :: editor :: keyword :: hits :: dayhits :: weekhits :: monthhits :: commentcount :: updatetime :: createtime :: operatingsystem :: softtype :: softlanguage :: copyrighttype :: softsize :: regurl :: ontop :: elite :: status :: softintro :: softpicurl :: downloadurl :: infopoint :: deleted :: stars :: decompresspassword :: lasthittime :: templateid :: skinid :: errortimes :: voteid :: presentexp :: browsetimes :: infopurview :: arrgroupid :: chargetype :: pitchtime :: readtimes :: dividepercent :: blogid :: HNil)
        .mapTo[PeSoftRow]
