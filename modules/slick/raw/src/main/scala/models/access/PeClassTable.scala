...
trait PeClassTable {
  ...
  case class PeClassRow(classid: Int, channelid: Int, classname: String, classtype: Int, opentype: Int, parentid: Int, parentpath: String, depth: Int, rootid: Int, child: Int, arrchildid: Option[String], previd: Int, nextid: Int, orderid: Int, tips: Option[String], readme: Option[String], metaKeywords: Option[String], metaDescription: Option[String], linkurl: Option[String], classpicurl: Option[String], classdir: Option[String], parentdir: Option[String], skinid: Option[Int], templateid: Option[Int], showontop: Boolean, showonindex: Boolean, iselite: Boolean, enableadd: Boolean, enableprotect: Boolean, maxperpage: Option[Int], defaultitemtemplate: Option[Int], defaultitemskin: Option[Int], itemlistordertype: Option[Int], itemopentype: Option[Int], itemcount: Option[Int], classpurview: Option[Short] = Some(0), enablecomment: Option[Boolean], checkcomment: Option[Boolean], presentexp: Option[Double] = Some(0.0), defaultitempoint: Option[Double] = Some(0.0), defaultitemchargetype: Option[Int] = Some(0), defaultitempitchtime: Option[Int] = Some(0), defaultitemreadtimes: Option[Int] = Some(0), defaultitemdividepercent: Option[Int] = Some(0), customContent: Option[String], commandclasspoint: Option[Int], releaseclasspoint: Option[Int])
  ...
  class PeClass(_tableTag: Tag) extends profile.api.Table[PeClassRow](_tableTag, "PE_Class") {
    def * = (classid :: channelid :: classname :: classtype :: opentype :: parentid :: parentpath :: depth :: rootid :: child :: arrchildid :: previd :: nextid :: orderid :: tips :: readme :: metaKeywords :: metaDescription :: linkurl :: classpicurl :: classdir :: parentdir :: skinid :: templateid :: showontop :: showonindex :: iselite :: enableadd :: enableprotect :: maxperpage :: defaultitemtemplate :: defaultitemskin :: itemlistordertype :: itemopentype :: itemcount :: classpurview :: enablecomment :: checkcomment :: presentexp :: defaultitempoint :: defaultitemchargetype :: defaultitempitchtime :: defaultitemreadtimes :: defaultitemdividepercent :: customContent :: commandclasspoint :: releaseclasspoint :: HNil).mapTo[PeClassRow]
    ...
    val index1 = index("PE_CLASS_CHANNELID", channelid :: HNil)
    /** Index over (classtype) (database name PE_CLASS_CLASSTYPE) */
    val index2 = index("PE_CLASS_CLASSTYPE", classtype :: HNil)
    /** Index over (nextid) (database name PE_CLASS_NEXTID) */
    val index3 = index("PE_CLASS_NEXTID", nextid :: HNil)
    /** Index over (orderid) (database name PE_CLASS_ORDERID) */
    val index4 = index("PE_CLASS_ORDERID", orderid :: HNil)
    /** Index over (parentid) (database name PE_CLASS_PARENTID) */
    val index5 = index("PE_CLASS_PARENTID", parentid :: HNil)
    /** Index over (previd) (database name PE_CLASS_PREVID) */
    val index6 = index("PE_CLASS_PREVID", previd :: HNil)
    /** Index over (rootid) (database name PE_CLASS_ROOTID) */
    val index7 = index("PE_CLASS_ROOTID", rootid :: HNil)
    /** Index over (skinid) (database name PE_CLASS_SKINID) */
    val index8 = index("PE_CLASS_SKINID", skinid :: HNil)
    /** Index over (templateid) (database name PE_CLASS_TEMPLATEID) */
    val index9 = index("PE_CLASS_TEMPLATEID", templateid :: HNil)
  }
