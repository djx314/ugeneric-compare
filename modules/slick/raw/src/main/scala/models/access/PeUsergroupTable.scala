...
trait PeUsergroupTable {
  ...
  case class PeUsergroupRow(
    groupid: Int = 0,
    groupname: String,
    groupintro: Option[String],
    grouptype: Option[Short],
    arrclassBrowse: Option[String],
    arrclassView: Option[String],
    arrclassInput: Option[String],
    groupsetting: Option[String]
  )
  ...
  class PeUsergroup(_tableTag: Tag) extends profile.api.Table[PeUsergroupRow](_tableTag, "PE_UserGroup") {
    def * = (groupid :: groupname :: groupintro :: grouptype :: arrclassBrowse :: arrclassView :: arrclassInput :: groupsetting :: HNil).mapTo[PeUsergroupRow]
