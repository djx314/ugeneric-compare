...
trait PeEquipmentTable {
  ...
  case class PeEquipmentRow(
    id: Int,
    classroomid: Option[Int] = Some(0),
    equipmentname: Option[String],
    equipmentintroduce: Option[String],
    equipmentsituation: Option[Int] = Some(0),
    equipmentvalue: Option[String],
  ...
  class PeEquipment(_tableTag: Tag) extends profile.api.Table[PeEquipmentRow](_tableTag, "PE_Equipment") {
    def * = (id :: classroomid :: equipmentname :: equipmentintroduce :: equipmentsituation :: equipmentvalue :: explain :: HNil).mapTo[PeEquipmentRow]
    ...
    val index1 = index("PE_EQUIPMENT_CLASSROOMID", classroomid :: HNil)
  }
