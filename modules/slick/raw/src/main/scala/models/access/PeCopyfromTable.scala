...
trait PeCopyfromTable {
  ...
  case class PeCopyfromRow(
    ...
    sourcetype: Option[Short] = Some(0),
  ...
  class PeCopyfrom(_tableTag: Tag) extends profile.api.Table[PeCopyfromRow](_tableTag, "PE_CopyFrom") {
    def * =
      (id :: channelid :: sourcename :: photo :: intro :: address :: tel :: fax :: mail :: zipcode :: homepage :: email :: qq :: contactername :: sourcetype :: passed :: ontop :: iselite :: hits :: lastusetime :: HNil)
        .mapTo[PeCopyfromRow]
