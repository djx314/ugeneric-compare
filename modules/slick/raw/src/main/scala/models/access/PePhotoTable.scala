...
trait PePhotoTable {
  ...
  case class PePhotoRow(
    ...
    photothumb: Option[String],
    photourl: Option[String],
    photosize: Option[Int],
    ontop: Boolean,
    elite: Boolean,
    status: Int = 0,
    photointro: Option[String],
  ...
  class PePhoto(_tableTag: Tag) extends profile.api.Table[PePhotoRow](_tableTag, "PE_Photo") {
    def * =
      (photoid :: channelid :: classid :: photoname :: author :: copyfrom :: inputer :: editor :: keyword :: hits :: dayhits :: weekhits :: monthhits :: commentcount :: updatetime :: createtime :: photothumb :: photourl :: photosize :: ontop :: elite :: status :: photointro :: infopoint :: deleted :: stars :: lasthittime :: templateid :: skinid :: voteid :: presentexp :: infopurview :: arrgroupid :: chargetype :: pitchtime :: readtimes :: dividepercent :: blogid :: HNil)
        .mapTo[PePhotoRow]
