...
trait PeHousecsTable {
  ...
  case class PeHousecsRow(
    houseid: Int = 0,
    classid: Option[Int] = Some(1),
    channelid: Option[Int] = Some(998),
    housesource: Option[String],
    housequyu: Option[String],
    housedizhi: Option[String],
    housexiangxidizhi: Option[String],
    househuxing: Option[String],
    housemianji: scala.math.BigDecimal = scala.math.BigDecimal("0"),
    housechanquan: Option[String],
    housejiancheng: Option[String],
    ...
    houseshuidian: Option[String],
    housedianqi: Option[String],
    housejiaju: Option[String],
    housegongjiaolu: Option[String],
    housegongjiaozhan: Option[String],
    houseshizheng: Option[String],
    jiaofangstartdate: Option[java.sql.Timestamp],
    totalprice: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    otherprice: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    housezhifu: Option[String],
    housepricetype: Option[String],
    shuifei: Option[String],
    contactname: String,
    contactphone: String,
  ...
  class PeHousecs(_tableTag: Tag) extends profile.api.Table[PeHousecsRow](_tableTag, "PE_HouseCS") {
    def * =
      (houseid :: classid :: channelid :: housesource :: housequyu :: housedizhi :: housexiangxidizhi :: househuxing :: housemianji :: housechanquan :: housejiancheng :: houselouceng :: housechaoxiang :: houseleixing :: housejichu :: housezhuangxiu :: houseshuidian :: housedianqi :: housejiaju :: housegongjiaolu :: housegongjiaozhan :: houseshizheng :: jiaofangstartdate :: totalprice :: otherprice :: housezhifu :: housepricetype :: shuifei :: contactname :: contactphone :: contactemail :: contactqq :: keyword :: youxiaoqi :: houseqita :: editor :: updatetime :: hits :: viewall :: hot :: ontop :: elite :: passed :: deleted :: commendclassdays :: uploadphotos :: HNil)
        .mapTo[PeHousecsRow]
    ...
    val index1 = index("PE_HOUSECS_CHANNELID", channelid :: HNil)

    /** Index over (classid) (database name PE_HOUSECS_CLASSID) */
    val index2 = index("PE_HOUSECS_CLASSID", classid :: HNil)

    /** Index over (elite) (database name PE_HOUSECS_ELITE) */
    val index3 = index("PE_HOUSECS_ELITE", elite :: HNil)

    /** Index over (housemianji) (database name PE_HOUSECS_FW_MIANJI) */
    val index4 = index("PE_HOUSECS_FW_MIANJI", housemianji :: HNil)

    /** Index over (hits) (database name PE_HOUSECS_HITS) */
    val index5 = index("PE_HOUSECS_HITS", hits :: HNil)

    /** Index over (keyword) (database name PE_HOUSECS_KEY) */
    val index6 = index("PE_HOUSECS_KEY", keyword :: HNil)

    /** Index over (ontop) (database name PE_HOUSECS_ONTOP) */
    val index7 = index("PE_HOUSECS_ONTOP", ontop :: HNil)

    /** Index over (passed) (database name PE_HOUSECS_PASSED) */
    val index8 = index("PE_HOUSECS_PASSED", passed :: HNil)

    /** Index over (updatetime) (database name PE_HOUSECS_UPDATETIME) */
    val index9 = index("PE_HOUSECS_UPDATETIME", updatetime :: HNil)
  }
