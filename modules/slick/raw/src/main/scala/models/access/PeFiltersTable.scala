...
trait PeFiltersTable {
  ...
  case class PeFiltersRow(
    filterid: Int,
    itemid: Option[Int] = Some(0),
    filtername: Option[String],
    filterobject: Option[Int] = Some(2),
    filtertype: Option[Int] = Some(1),
    filtercontent: Option[String],
    fisstring: Option[String],
    fiostring: Option[String],
    filterrep: Option[String],
    flag: Option[Boolean]
  )
  ...
  class PeFilters(_tableTag: Tag) extends profile.api.Table[PeFiltersRow](_tableTag, "PE_Filters") {
    def * = (filterid :: itemid :: filtername :: filterobject :: filtertype :: filtercontent :: fisstring :: fiostring :: filterrep :: flag :: HNil).mapTo[PeFiltersRow]
    ...
    val index1 = index("PE_FILTERS_ITEMID", itemid :: HNil)
  }
