...
trait PeSpaceTable {
  ...
  class PeSpace(_tableTag: Tag) extends profile.api.Table[PeSpaceRow](_tableTag, "PE_Space") {
    def * = (id :: userid :: classid :: name :: birthday :: photo :: intro :: address :: tel :: fax :: company :: department :: zipcode :: homepage :: email :: qq :: `type` :: lastusetime :: ontop :: passed :: iselite :: hits :: orderid :: linkurl :: listnum :: HNil).mapTo[PeSpaceRow]
