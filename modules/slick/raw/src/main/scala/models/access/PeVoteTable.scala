...
trait PeVoteTable {
  ...
  case class PeVoteRow(
    ...
    answer8: Option[Int],
    votetime: Option[java.sql.Timestamp],
    endtime: Option[java.sql.Timestamp],
    votetype: Option[String],
    isselected: Boolean,
    channelid: Option[Int],
    isitem: Option[Boolean],
    select9: Option[String],
    select10: Option[String],
    select11: Option[String],
    select12: Option[String],
    select13: Option[String],
    select14: Option[String],
    select15: Option[String],
    select16: Option[String],
    select17: Option[String],
    select18: Option[String],
    select19: Option[String],
    select20: Option[String],
    answer9: Option[Int],
    answer10: Option[Int],
    answer11: Option[Int],
    answer12: Option[Int],
  ...
  class PeVote(_tableTag: Tag) extends profile.api.Table[PeVoteRow](_tableTag, "PE_Vote") {
    def * =
      (id :: title :: select1 :: answer1 :: select2 :: answer2 :: select3 :: answer3 :: select4 :: answer4 :: select5 :: answer5 :: select6 :: answer6 :: select7 :: answer7 :: select8 :: answer8 :: votetime :: endtime :: votetype :: isselected :: channelid :: isitem :: select9 :: select10 :: select11 :: select12 :: select13 :: select14 :: select15 :: select16 :: select17 :: select18 :: select19 :: select20 :: answer9 :: answer10 :: answer11 :: answer12 :: answer13 :: answer14 :: answer15 :: answer16 :: answer17 :: answer18 :: answer19 :: answer20 :: votenum :: HNil)
        .mapTo[PeVoteRow]
    ...
    val index1 = index("PE_VOTE_CHANNELID", channelid :: HNil)
  }
