...
trait PeClientTable {
  ...
  class PeClient(_tableTag: Tag) extends profile.api.Table[PeClientRow](_tableTag, "PE_Client") {
    def * =
      (clientid :: parentid :: clientnum :: clienttype :: clientname :: shortedform :: area :: clientfield :: valuelevel :: creditlevel :: importance :: connectionlevel :: groupid :: sourcetype :: phasetype :: remark :: visittimes :: servicetimes :: complaintimes :: lastvisittime :: lastservicetime :: lastcomplaintime :: createtime :: updatetime :: owner :: balance :: HNil)
        .mapTo[PeClientRow]
