...
trait PeClientTable {
  ...
  case class PeClientRow(clientid: Int = 0, parentid: Option[Int] = Some(0), clientnum: Option[String], clienttype: Option[Int] = Some(0), clientname: Option[String], shortedform: Option[String], area: Option[Int] = Some(0), clientfield: Option[Int] = Some(0), valuelevel: Option[Int] = Some(0), creditlevel: Option[Int] = Some(0), importance: Option[Int] = Some(0), connectionlevel: Option[Int] = Some(0), groupid: Option[Int] = Some(0), sourcetype: Option[Int] = Some(0), phasetype: Option[Int] = Some(0), remark: Option[String], visittimes: Option[Int] = Some(0), servicetimes: Option[Int] = Some(0), complaintimes: Option[Int] = Some(0), lastvisittime: Option[java.sql.Timestamp], lastservicetime: Option[java.sql.Timestamp], lastcomplaintime: Option[java.sql.Timestamp], createtime: Option[java.sql.Timestamp], updatetime: Option[java.sql.Timestamp], owner: Option[String], balance: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")))
  ...
  class PeClient(_tableTag: Tag) extends profile.api.Table[PeClientRow](_tableTag, "PE_Client") {
    def * = (clientid :: parentid :: clientnum :: clienttype :: clientname :: shortedform :: area :: clientfield :: valuelevel :: creditlevel :: importance :: connectionlevel :: groupid :: sourcetype :: phasetype :: remark :: visittimes :: servicetimes :: complaintimes :: lastvisittime :: lastservicetime :: lastcomplaintime :: createtime :: updatetime :: owner :: balance :: HNil).mapTo[PeClientRow]
    ...
    val index1 = index("PE_CLIENT_CLIENTNUM", clientnum :: HNil)
    /** Index over (groupid) (database name PE_CLIENT_GROUPID) */
    val index2 = index("PE_CLIENT_GROUPID", groupid :: HNil)
    /** Index over (parentid) (database name PE_CLIENT_PARENTID) */
    val index3 = index("PE_CLIENT_PARENTID", parentid :: HNil)
  }
