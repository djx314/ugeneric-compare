...
trait PeDownserverTable {
  ...
  class PeDownserver(_tableTag: Tag) extends profile.api.Table[PeDownserverRow](_tableTag, "PE_DownServer") {
    def * =
      (serverid :: channelid :: servername :: serverurl :: serverlogo :: orderid :: showtype :: infopoint :: infopurview :: arrgroupid :: chargetype :: pitchtime :: readtimes :: dividepercent :: HNil)
        .mapTo[PeDownserverRow]
