...
trait PeProductTable {
  ...
  case class PeProductRow(
    productid: Int = 0,
    channelid: Option[Int] = Some(0),
    productnum: Option[String],
    barcode: Option[String],
    classid: Option[Int] = Some(0),
    productkind: Option[Int] = Some(0),
    productname: Option[String],
    productmodel: Option[String],
    productstandard: Option[String],
    producername: Option[String],
    trademarkname: Option[String],
    productintro: Option[String],
    productexplain: Option[String],
    productthumb: Option[String],
    uploadfiles: Option[String],
    producttype: Option[Int] = Some(0),
    ...
    priceMarket: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    priceMember: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    priceAgent: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    enablewholesale: Option[Boolean],
    priceWholesale1: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    numberWholesale1: Option[Int] = Some(0),
    priceWholesale2: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    numberWholesale2: Option[Int] = Some(0),
    priceWholesale3: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    numberWholesale3: Option[Int] = Some(0),
    unit: Option[String],
    ontop: Option[Boolean],
    ishot: Option[Boolean],
    iselite: Option[Boolean],
    stars: Option[Int] = Some(0),
    stocks: Option[Double] = Some(0.0),
    ordernum: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    alarmnum: Option[Int] = Some(0),
    enablesale: Option[Boolean],
    discount: Option[Double] = Some(0.0),
    begindate: Option[java.sql.Timestamp],
    enddate: Option[java.sql.Timestamp],
    limitnum: Option[Double] = Some(0.0),
    ...
    buytimes: Option[Int] = Some(0),
    deleted: Option[Boolean],
    inputer: Option[String],
    templateid: Option[Int] = Some(0),
    skinid: Option[Int] = Some(0),
    voteid: Option[Int] = Some(0),
    salepromotiontype: Option[Int] = Some(0),
    minnumber: Option[Int] = Some(0),
    presentnumber: Option[Int] = Some(0),
    presentid: Option[String],
    ...
    weight: Option[Double] = Some(0.0),
    enablesinglesell: Option[Boolean],
    dependentproducts: Option[String]
  )
  ...
  class PeProduct(_tableTag: Tag) extends profile.api.Table[PeProductRow](_tableTag, "PE_Product") {
    def * =
      (productid :: channelid :: productnum :: barcode :: classid :: productkind :: productname :: productmodel :: productstandard :: producername :: trademarkname :: productintro :: productexplain :: productthumb :: uploadfiles :: producttype :: price :: priceOriginal :: priceMarket :: priceMember :: priceAgent :: enablewholesale :: priceWholesale1 :: numberWholesale1 :: priceWholesale2 :: numberWholesale2 :: priceWholesale3 :: numberWholesale3 :: unit :: ontop :: ishot :: iselite :: stars :: stocks :: ordernum :: alarmnum :: enablesale :: discount :: begindate :: enddate :: limitnum :: keyword :: commentcount :: updatetime :: createtime :: downloadurl :: remark :: serviceterm :: hits :: buytimes :: deleted :: inputer :: templateid :: skinid :: voteid :: salepromotiontype :: minnumber :: presentnumber :: presentid :: presentmoney :: presentpoint :: presentexp :: weight :: enablesinglesell :: dependentproducts :: HNil)
        .mapTo[PeProductRow]
    ...
    val index1 = index("PE_PRODUCT_ALARMNUM", alarmnum :: HNil)

    /** Index over (channelid) (database name PE_PRODUCT_CHANNELID) */
    val index2 = index("PE_PRODUCT_CHANNELID", channelid :: HNil)

    /** Index over (classid) (database name PE_PRODUCT_CLASSID) */
    val index3 = index("PE_PRODUCT_CLASSID", classid :: HNil)

    /** Index over (keyword) (database name PE_PRODUCT_KEYWORD) */
    val index4 = index("PE_PRODUCT_KEYWORD", keyword :: HNil)

    /** Index over (limitnum) (database name PE_PRODUCT_LIMITNUM) */
    val index5 = index("PE_PRODUCT_LIMITNUM", limitnum :: HNil)

    /** Index over (numberWholesale2) (database name PE_PRODUCT_NUMBER_WHOLESALE1) */
    val index6 = index("PE_PRODUCT_NUMBER_WHOLESALE1", numberWholesale2 :: HNil)

    /** Index over (numberWholesale3) (database name PE_PRODUCT_NUMBER_WHOLESALE11) */
    val index7 = index("PE_PRODUCT_NUMBER_WHOLESALE11", numberWholesale3 :: HNil)

    /** Index over (numberWholesale1) (database name PE_PRODUCT_NUMER_WHOLESALE) */
    val index8 = index("PE_PRODUCT_NUMER_WHOLESALE", numberWholesale1 :: HNil)

    /** Index over (ordernum) (database name PE_PRODUCT_ORDERNUM) */
    val index9 = index("PE_PRODUCT_ORDERNUM", ordernum :: HNil)

    /** Index over (presentid) (database name PE_PRODUCT_PRESENTID) */
    val index10 = index("PE_PRODUCT_PRESENTID", presentid :: HNil)

    /** Index over (producername) (database name PE_PRODUCT_PRODUCERID) */
    val index11 = index("PE_PRODUCT_PRODUCERID", producername :: HNil)

    /** Index over (productkind) (database name PE_PRODUCT_PRODUCTKIND) */
    val index12 = index("PE_PRODUCT_PRODUCTKIND", productkind :: HNil)

    /** Index over (productnum) (database name PE_PRODUCT_PRODUCTNUM) */
    val index13 = index("PE_PRODUCT_PRODUCTNUM", productnum :: HNil)

    /** Index over (skinid) (database name PE_PRODUCT_SKINID) */
    val index14 = index("PE_PRODUCT_SKINID", skinid :: HNil)

    /** Index over (templateid) (database name PE_PRODUCT_TEMPLATEID) */
    val index15 = index("PE_PRODUCT_TEMPLATEID", templateid :: HNil)

    /** Index over (trademarkname) (database name PE_PRODUCT_TRADEMARKID) */
    val index16 = index("PE_PRODUCT_TRADEMARKID", trademarkname :: HNil)
  }
