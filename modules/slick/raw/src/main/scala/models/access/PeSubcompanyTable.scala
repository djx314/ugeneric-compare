...
trait PeSubcompanyTable {
  ...
  case class PeSubcompanyRow(
    subcompanyid: Int = 0,
    subcompanyname: Option[String],
    contacter: Option[String],
  ...
  class PeSubcompany(_tableTag: Tag) extends profile.api.Table[PeSubcompanyRow](_tableTag, "PE_SubCompany") {
    def * = (subcompanyid :: subcompanyname :: contacter :: telephone :: address :: eMail :: orderid :: HNil).mapTo[PeSubcompanyRow]
    ...
    val index1 = index("PE_SUBCOMPANY_ORDERID", orderid :: HNil)
  }
