...
trait PeDelivertypeTable {
  ...
  case class PeDelivertypeRow(typeid: Int = 0, typename: Option[String], intro: Option[String], chargetype: Option[Int] = Some(0), isdefault: Option[Boolean], isdisabled: Option[Boolean], orderid: Option[Int] = Some(0), releasetype: Option[Int] = Some(0), minmoney1: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), releasecharge: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), minmoney2: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), maxcharge: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), minmoney3: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), chargeMin: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), chargeMax: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), chargePercent: Option[Short] = Some(0))
  ...
  class PeDelivertype(_tableTag: Tag) extends profile.api.Table[PeDelivertypeRow](_tableTag, "PE_DeliverType") {
    def * = (typeid :: typename :: intro :: chargetype :: isdefault :: isdisabled :: orderid :: releasetype :: minmoney1 :: releasecharge :: minmoney2 :: maxcharge :: minmoney3 :: chargeMin :: chargeMax :: chargePercent :: HNil).mapTo[PeDelivertypeRow]
    ...
    val index1 = index("PE_DELIVERTYPE_ORDERID", orderid :: HNil)
  }
