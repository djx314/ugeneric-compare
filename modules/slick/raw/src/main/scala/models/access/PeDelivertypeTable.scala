...
trait PeDelivertypeTable {
  ...
  class PeDelivertype(_tableTag: Tag) extends profile.api.Table[PeDelivertypeRow](_tableTag, "PE_DeliverType") {
    def * =
      (typeid :: typename :: intro :: chargetype :: isdefault :: isdisabled :: orderid :: releasetype :: minmoney1 :: releasecharge :: minmoney2 :: maxcharge :: minmoney3 :: chargeMin :: chargeMax :: chargePercent :: HNil)
        .mapTo[PeDelivertypeRow]
