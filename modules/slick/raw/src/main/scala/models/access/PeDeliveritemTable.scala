...
trait PeDeliveritemTable {
  ...
  case class PeDeliveritemRow(deliverid: Int, orderformid: Option[Int] = Some(0), deliverdate: Option[java.sql.Timestamp], deliverdirection: Option[Int] = Some(0), handlername: Option[String], expresscompany: Option[String], expressnumber: Option[String], inputer: Option[String], remark: Option[String], received: Option[Boolean])
  ...
  class PeDeliveritem(_tableTag: Tag) extends profile.api.Table[PeDeliveritemRow](_tableTag, "PE_DeliverItem") {
    def * = (deliverid :: orderformid :: deliverdate :: deliverdirection :: handlername :: expresscompany :: expressnumber :: inputer :: remark :: received :: HNil).mapTo[PeDeliveritemRow]
    ...
    val index1 = index("PE_DELIVERITEM_ORDERFORMID", orderformid :: HNil)
  }
