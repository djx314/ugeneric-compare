...
trait PePositionTable {
  ...
  class PePosition(_tableTag: Tag) extends profile.api.Table[PePositionRow](_tableTag, "PE_Position") {
    def * =
      (positionid :: jobcategoryid :: subcompanyid :: workplaceid :: releasedate :: positionname :: positionnum :: validdate :: positionkeyword :: positiondescription :: dutyrequest :: positionstatus :: subcompanyname :: urgent :: HNil)
        .mapTo[PePositionRow]
