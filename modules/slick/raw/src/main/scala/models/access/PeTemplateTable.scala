...
trait PeTemplateTable {
  ...
  case class PeTemplateRow(
    ...
    isdefaultinproject: Option[Boolean],
  ...
  class PeTemplate(_tableTag: Tag) extends profile.api.Table[PeTemplateRow](_tableTag, "PE_Template") {
    def * =
      (templateid :: channelid :: templatename :: templatetype :: templatecontent :: isdefault :: projectname :: isdefaultinproject :: deleted :: HNil)
        .mapTo[PeTemplateRow]
