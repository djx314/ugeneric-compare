...
trait PeSurveyrecordTable {
  ...
  case class PeSurveyrecordRow(
    recordid: Int,
    surveyid: Option[Int] = Some(0),
    username: Option[String],
    ip: Option[String],
    answer: Option[String],
    submittime: Option[java.sql.Timestamp]
  )
  ...
  class PeSurveyrecord(_tableTag: Tag) extends profile.api.Table[PeSurveyrecordRow](_tableTag, "PE_SurveyRecord") {
    def * = (recordid :: surveyid :: username :: ip :: answer :: submittime :: HNil).mapTo[PeSurveyrecordRow]
    ...
    val index1 = index("PE_SURVEYRECORD_SURVEYID", surveyid :: HNil)
  }
