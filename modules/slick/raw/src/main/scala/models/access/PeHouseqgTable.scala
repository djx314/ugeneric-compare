...
// AUTO-GENERATED Slick data model for table PeHouseqg
trait PeHouseqgTable {
  ...
  /** Entity class storing rows of table PeHouseqg
    *  @param houseid Database column HouseID SqlType(INTEGER), PrimaryKey, Default(0)
    *  @param classid Database column ClassID SqlType(INTEGER), Default(Some(3))
    ...
    *  @param housejiancheng1 Database column HouseJianCheng1 SqlType(VARCHAR), Length(20,true)
    *  @param housejiancheng2 Database column HouseJianCheng2 SqlType(VARCHAR), Length(20,true)
    *  @param houseleixing Database column HouseLeiXing SqlType(VARCHAR), Length(20,true)
    *  @param housexingzhi Database column HouseXingZhi SqlType(VARCHAR), Length(20,true)
    ...
    *  @param housechaoxiang Database column HouseChaoXiang SqlType(VARCHAR), Length(10,true)
    *  @param housepricetype Database column HousePriceType SqlType(VARCHAR), Length(10,true)
    *  @param houseprice1 Database column HousePrice1 SqlType(NUMERIC), Default(Some(0))
    *  @param houseprice2 Database column HousePrice2 SqlType(NUMERIC), Default(Some(0))
    *  @param housezhifu Database column HouseZhiFu SqlType(VARCHAR), Length(10,true)
  ...
  case class PeHouseqgRow(
    houseid: Int = 0,
    classid: Option[Int] = Some(3),
    channelid: Option[Int] = Some(998),
    housesource: Option[String],
    housequyu: Option[String],
    housedizhi: Option[String],
    housejiancheng1: Option[String],
    housejiancheng2: Option[String],
    houseleixing: Option[String],
    housexingzhi: Option[String],
    househuxing: Option[String],
    housemianji1: scala.math.BigDecimal = scala.math.BigDecimal("0"),
    housemianji2: scala.math.BigDecimal = scala.math.BigDecimal("0"),
    houselouceng: Option[String],
    housechaoxiang: Option[String],
    housepricetype: Option[String],
    houseprice1: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    houseprice2: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")),
    housezhifu: Option[String],
    housejichu: Option[String],
    housezhuangxiu: Option[String],
    houseshizheng: Option[String],
    jiaofangstartdate: Option[java.sql.Timestamp],
    contactname: String,
    contactphone: String,
    contactemail: Option[String],
    contactqq: Option[String],
    keyword: String,
    youxiaoqi: Option[String],
    houseqita: Option[String],
    editor: Option[String],
    updatetime: Option[java.sql.Timestamp],
    viewall: Option[Boolean],
    ...
    deleted: Boolean,
    commendclassdays: Option[Int] = Some(0),
    uploadphotos: Option[String]
  )

  /** GetResult implicit for fetching PeHouseqgRow objects using plain SQL queries */
  /** Table description of table PE_HouseQG. Objects of this class serve as prototypes for rows in queries. */
  class PeHouseqg(_tableTag: Tag) extends profile.api.Table[PeHouseqgRow](_tableTag, "PE_HouseQG") {
    def * =
      (houseid :: classid :: channelid :: housesource :: housequyu :: housedizhi :: housejiancheng1 :: housejiancheng2 :: houseleixing :: housexingzhi :: househuxing :: housemianji1 :: housemianji2 :: houselouceng :: housechaoxiang :: housepricetype :: houseprice1 :: houseprice2 :: housezhifu :: housejichu :: housezhuangxiu :: houseshizheng :: jiaofangstartdate :: contactname :: contactphone :: contactemail :: contactqq :: keyword :: youxiaoqi :: houseqita :: editor :: updatetime :: viewall :: hits :: hot :: ontop :: elite :: passed :: deleted :: commendclassdays :: uploadphotos :: HNil)
        .mapTo[PeHouseqgRow]
    ...
    /** Database column ClassID SqlType(INTEGER), Default(Some(3)) */
    val classid: Rep[Option[Int]] = column[Option[Int]]("ClassID", O.Default(Some(3)))
    ...
    /** Database column HouseJianCheng1 SqlType(VARCHAR), Length(20,true) */
    val housejiancheng1: Rep[Option[String]] = column[Option[String]]("HouseJianCheng1", O.Length(20, varying = true))

    /** Database column HouseJianCheng2 SqlType(VARCHAR), Length(20,true) */
    val housejiancheng2: Rep[Option[String]] = column[Option[String]]("HouseJianCheng2", O.Length(20, varying = true))
    ...
    /** Database column HouseXingZhi SqlType(VARCHAR), Length(20,true) */
    val housexingzhi: Rep[Option[String]] = column[Option[String]]("HouseXingZhi", O.Length(20, varying = true))
    ...
    /** Database column HouseChaoXiang SqlType(VARCHAR), Length(10,true) */
    val housechaoxiang: Rep[Option[String]] = column[Option[String]]("HouseChaoXiang", O.Length(10, varying = true))

    /** Database column HousePriceType SqlType(VARCHAR), Length(10,true) */
    val housepricetype: Rep[Option[String]] = column[Option[String]]("HousePriceType", O.Length(10, varying = true))

    /** Database column HousePrice1 SqlType(NUMERIC), Default(Some(0)) */
    val houseprice1: Rep[Option[scala.math.BigDecimal]] = column[Option[scala.math.BigDecimal]]("HousePrice1", O.Default(Some(scala.math.BigDecimal("0"))))

    /** Database column HousePrice2 SqlType(NUMERIC), Default(Some(0)) */
    val houseprice2: Rep[Option[scala.math.BigDecimal]] = column[Option[scala.math.BigDecimal]]("HousePrice2", O.Default(Some(scala.math.BigDecimal("0"))))

    /** Database column HouseZhiFu SqlType(VARCHAR), Length(10,true) */
    val housezhifu: Rep[Option[String]] = column[Option[String]]("HouseZhiFu", O.Length(10, varying = true))
    ...
    /** Index over (channelid) (database name PE_HOUSEQG_CHANNELID) */
    val index1 = index("PE_HOUSEQG_CHANNELID", channelid :: HNil)

    /** Index over (classid) (database name PE_HOUSEQG_CLASSID) */
    val index2 = index("PE_HOUSEQG_CLASSID", classid :: HNil)

    /** Index over (elite) (database name PE_HOUSEQG_ELITE) */
    val index3 = index("PE_HOUSEQG_ELITE", elite :: HNil)

    /** Index over (housemianji1) (database name PE_HOUSEQG_FW_MIANJI) */
    val index4 = index("PE_HOUSEQG_FW_MIANJI", housemianji1 :: HNil)

    /** Index over (hits) (database name PE_HOUSEQG_HITS) */
    val index5 = index("PE_HOUSEQG_HITS", hits :: HNil)

    /** Index over (housemianji2) (database name PE_HOUSEQG_HOUSEMIANJI1) */
    val index6 = index("PE_HOUSEQG_HOUSEMIANJI1", housemianji2 :: HNil)

    /** Index over (keyword) (database name PE_HOUSEQG_KEY) */
    val index7 = index("PE_HOUSEQG_KEY", keyword :: HNil)

    /** Index over (ontop) (database name PE_HOUSEQG_ONTOP) */
    val index8 = index("PE_HOUSEQG_ONTOP", ontop :: HNil)

    /** Index over (passed) (database name PE_HOUSEQG_PASSED) */
    val index9 = index("PE_HOUSEQG_PASSED", passed :: HNil)

    /** Index over (updatetime) (database name PE_HOUSEQG_UPDATETIME) */
    val index10 = index("PE_HOUSEQG_UPDATETIME", updatetime :: HNil)
  }

  /** Collection-like TableQuery object for table PeHouseqg */
  lazy val PeHouseqg = new TableQuery(tag => new PeHouseqg(tag))
}
