...
trait PeComplainitemTable {
  ...
  case class PeComplainitemRow(itemid: Int, clientid: Option[Int] = Some(0), contacterid: Option[Int] = Some(0), complaintype: Option[Int] = Some(0), complainmode: Option[Int] = Some(0), title: Option[String], content: Option[String], firstreceiver: Option[String], dateandtime: Option[java.sql.Timestamp], magnitudeofexigence: Option[Int] = Some(0), process: Option[String], processor: Option[String], result: Option[String], endtime: Option[java.sql.Timestamp], feedback: Option[String], confirmtime: Option[java.sql.Timestamp], confirmcaller: Option[String], confirmscore: Option[Int] = Some(0), confirmfeedback: Option[String], status: Option[Int] = Some(0), currentowner: Option[String], remark: Option[String], defendant: Option[String])
  ...
  class PeComplainitem(_tableTag: Tag) extends profile.api.Table[PeComplainitemRow](_tableTag, "PE_ComplainItem") {
    def * = (itemid :: clientid :: contacterid :: complaintype :: complainmode :: title :: content :: firstreceiver :: dateandtime :: magnitudeofexigence :: process :: processor :: result :: endtime :: feedback :: confirmtime :: confirmcaller :: confirmscore :: confirmfeedback :: status :: currentowner :: remark :: defendant :: HNil).mapTo[PeComplainitemRow]
    ...
    val index1 = index("PE_COMPLAINITEM_CONTACTERID", contacterid :: HNil)
    /** Index over (clientid) (database name PE_COMPLAINITEM_USERID) */
    val index2 = index("PE_COMPLAINITEM_USERID", clientid :: HNil)
  }
