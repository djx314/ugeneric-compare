...
trait PeSupplyTable {
  ...
  class PeSupply(_tableTag: Tag) extends profile.api.Table[PeSupplyRow](_tableTag, "PE_Supply") {
    def * =
      (supplyid :: channelid :: classid :: specialid :: supplyname :: supplytype :: supplytitle :: supplyintro :: supplyperiod :: tradetype :: priceintro :: supplypicurl :: templateid :: skinid :: status :: username :: hits :: updatetime :: deleted :: commandtype :: commandchanneldays :: commandclassdays :: HNil)
        .mapTo[PeSupplyRow]
