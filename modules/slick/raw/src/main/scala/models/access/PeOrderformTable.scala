...
trait PeOrderformTable {
  ...
  case class PeOrderformRow(orderformid: Int = 0, orderformnum: Option[String], username: Option[String], agentname: Option[String], clientid: Option[Int] = Some(0), moneytotal: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), moneygoods: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), needinvoice: Option[Boolean], invoicecontent: Option[String], invoiced: Option[Boolean], remark: Option[String], moneyreceipt: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), begindate: Option[java.sql.Timestamp], inputtime: Option[java.sql.Timestamp], contactername: Option[String], address: Option[String], zipcode: Option[String], mobile: Option[String], phone: Option[String], email: Option[String], paymenttype: Option[Int] = Some(0), delivertype: Option[Int] = Some(0), status: Option[Int] = Some(0), deliverstatus: Option[Int] = Some(0), enabledownload: Option[Boolean], presentmoney: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), presentpoint: Option[Int] = Some(0), presentexp: Option[Int] = Some(0), discountPayment: Option[Double] = Some(0.0), chargeDeliver: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")))
  ...
  class PeOrderform(_tableTag: Tag) extends profile.api.Table[PeOrderformRow](_tableTag, "PE_OrderForm") {
    def * = (orderformid :: orderformnum :: username :: agentname :: clientid :: moneytotal :: moneygoods :: needinvoice :: invoicecontent :: invoiced :: remark :: moneyreceipt :: begindate :: inputtime :: contactername :: address :: zipcode :: mobile :: phone :: email :: paymenttype :: delivertype :: status :: deliverstatus :: enabledownload :: presentmoney :: presentpoint :: presentexp :: discountPayment :: chargeDeliver :: HNil).mapTo[PeOrderformRow]
