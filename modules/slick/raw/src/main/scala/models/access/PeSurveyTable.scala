...
trait PeSurveyTable {
  ...
  case class PeSurveyRow(surveyid: Int, surveyname: Option[String], description: Option[String], filename: Option[String], iprepeat: Option[Int] = Some(0), createdate: Option[java.sql.Timestamp], endtime: Option[java.sql.Timestamp], isopen: Option[Int] = Some(0), needlogin: Option[Int] = Some(0), presentpoint: Option[Int] = Some(0), lockiptype: Option[Int] = Some(0), setiplock: Option[String], lockurl: Option[String], setpassword: Option[String], templateid: Option[Int] = Some(0))
  ...
  class PeSurvey(_tableTag: Tag) extends profile.api.Table[PeSurveyRow](_tableTag, "PE_Survey") {
    def * = (surveyid :: surveyname :: description :: filename :: iprepeat :: createdate :: endtime :: isopen :: needlogin :: presentpoint :: lockiptype :: setiplock :: lockurl :: setpassword :: templateid :: HNil).mapTo[PeSurveyRow]
