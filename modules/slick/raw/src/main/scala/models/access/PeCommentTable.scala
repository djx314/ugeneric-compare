...
trait PeCommentTable {
  ...
  class PeComment(_tableTag: Tag) extends profile.api.Table[PeCommentRow](_tableTag, "PE_Comment") {
    def * = (commentid :: moduletype :: infoid :: usertype :: username :: sex :: oicq :: msn :: icq :: email :: homepage :: ip :: writetime :: score :: content :: replyname :: replycontent :: replytime :: passed :: support :: opposed :: HNil).mapTo[PeCommentRow]
