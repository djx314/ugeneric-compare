...
trait PeBankTable {
  ...
  case class PeBankRow(
    bankid: Int = 0,
    bankshortname: Option[String],
    bankname: Option[String],
    accounts: Option[String],
    cardnum: Option[String],
    holdername: Option[String],
    bankintro: Option[String],
    bankpic: Option[String],
  ...
  class PeBank(_tableTag: Tag) extends profile.api.Table[PeBankRow](_tableTag, "PE_Bank") {
    def * =
      (bankid :: bankshortname :: bankname :: accounts :: cardnum :: holdername :: bankintro :: bankpic :: isdefault :: orderid :: isdisabled :: HNil).mapTo[PeBankRow]
