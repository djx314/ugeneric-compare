...
trait PeContacterTable {
  ...
  case class PeContacterRow(
    ...
    nativeplace: Option[String],
    nation: Option[String],
    birthday: Option[java.sql.Timestamp],
    idcard: Option[String],
    marriage: Option[Short],
    family: Option[String],
    income: Option[Int],
    education: Option[Int] = Some(0),
    graduatefrom: Option[String],
    interestsoflife: Option[String],
    interestsofculture: Option[String],
    interestsofamusement: Option[String],
    interestsofsport: Option[String],
    interestsofother: Option[String],
    createtime: Option[java.sql.Timestamp],
    updatetime: Option[java.sql.Timestamp],
    owner: Option[String],
    arrchannelid: Option[String]
  )
  ...
  class PeContacter(_tableTag: Tag) extends profile.api.Table[PeContacterRow](_tableTag, "PE_Contacter") {
    def * =
      (contacterid :: clientid :: parentid :: usertype :: truename :: sex :: title :: company :: department :: position :: operation :: companyaddress :: email :: homepage :: qq :: icq :: msn :: yahoo :: uc :: aim :: officephone :: homephone :: phs :: fax :: mobile :: country :: province :: city :: address :: zipcode :: nativeplace :: nation :: birthday :: idcard :: marriage :: family :: income :: education :: graduatefrom :: interestsoflife :: interestsofculture :: interestsofamusement :: interestsofsport :: interestsofother :: createtime :: updatetime :: owner :: arrchannelid :: HNil)
        .mapTo[PeContacterRow]
