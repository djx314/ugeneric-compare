...
trait PeHouseconfigTable {
  ...
  case class PeHouseconfigRow(classid: Int, channelid: Int, classname: String, opentype: Int, classdir: Option[String], skinid: Option[Int], templateid: Option[Int], showontop: Boolean, maxperpage: Option[Int], releasedeductpoint: Option[Int] = Some(0), commendclasspoint: Option[Double] = Some(0.0), defaultitemtemplate: Option[Int], defaultitemskin: Option[Int], itemopentype: Option[Int], itemcount: Option[Int], upgradepoint: Option[Int] = Some(0), metaKeywords: Option[String], metaDescription: Option[String])
  ...
  class PeHouseconfig(_tableTag: Tag) extends profile.api.Table[PeHouseconfigRow](_tableTag, "PE_HouseConfig") {
    def * = (classid :: channelid :: classname :: opentype :: classdir :: skinid :: templateid :: showontop :: maxperpage :: releasedeductpoint :: commendclasspoint :: defaultitemtemplate :: defaultitemskin :: itemopentype :: itemcount :: upgradepoint :: metaKeywords :: metaDescription :: HNil).mapTo[PeHouseconfigRow]
