...
trait PeConfigTable {
  ...
  case class PeConfigRow(sitename: Option[String], sitetitle: Option[String], siteurl: Option[String], installdir: Option[String], logourl: Option[String], bannerurl: Option[String], webmastername: Option[String], webmasteremail: Option[String], copyright: Option[String], metaKeywords: Option[String], metaDescription: Option[String], sitekey: Option[String], showsitechannel: Boolean, showadminlogin: Boolean, enablesaveremote: Boolean, enablelinkreg: Boolean, enablecountfriendsitehits: Boolean, enablesoftkey: Boolean, objnameFso: Option[String], admindir: Option[String], addir: Option[String], announcecookietime: Option[Int] = Some(0), hitsofhot: Option[Int], fileextSiteindex: Option[Int] = Some(0), fileextSitespecial: Option[Int] = Some(0), siteurltype: Option[Int] = Some(0), modules: Option[String], lockiptype: Int = 0, lockip: Option[String], enableuserreg: Boolean, emailcheckreg: Boolean, admincheckreg: Boolean, enablemultiregperemail: Option[Boolean], usernamelimit: Option[Int] = Some(0), usernamemax: Option[Int] = Some(0), usernameRegdisabled: Option[String], regfieldsMustfill: Option[String], enablecheckcodeoflogin: Option[Boolean], enablecheckcodeofreg: Option[Boolean], enableqaofreg: Option[Boolean], qaofreg: Option[String], presentexp: Option[Double] = Some(0.0), presentmoney: Option[Double] = Some(0.0), presentpoint: Option[Int] = Some(0), presentvalidnum: Option[Int] = Some(0), presentvalidunit: Option[Int] = Some(0), moneyexchangepoint: Option[Double] = Some(0.0), moneyexchangevalidday: Option[Double] = Some(0.0), userexpexchangepoint: Option[Double] = Some(0.0), userexpexchangevalidday: Option[Double] = Some(0.0), presentexpperlogin: Option[Int] = Some(0), presentexpperelite: Option[Int] = Some(0), pointname: Option[String], pointunit: Option[String], emailofregcheck: Option[String], mailobject: Option[Int] = Some(0), mailserver: Option[String], mailserverusername: Option[String], mailserverpassword: Option[String], maildomain: Option[String], photoobject: Option[Int] = Some(0), thumbDefaultwidth: Option[Int] = Some(0), thumbDefaultheight: Option[Int] = Some(0), thumbArithmetic: Option[Int] = Some(0), watermarkType: Option[Int] = Some(0), watermarkText: Option[String], watermarkTextFontname: Option[String], watermarkTextFontsize: Option[Int] = Some(0), watermarkTextFontcolor: Option[String], watermarkTextBold: Option[Boolean], watermarkImagesFilename: Option[String], watermarkImagesTransparence: Option[Int] = Some(0), watermarkImagesBackgroundcolor: Option[String], watermarkPositionX: Option[Int] = Some(0), watermarkPositionY: Option[Int] = Some(0), watermarkPosition: Option[Int] = Some(0), searchinterval: Option[Int] = Some(0), searchresultnum: Option[Int] = Some(0), maxperpageSearchresult: Option[Int] = Some(0), searchcontent: Option[Boolean], enableguestbuy: Option[Boolean], includetax: Option[Boolean], taxrate: Option[Int] = Some(0), payonlineprovider: Option[Int] = Some(0), payonlineshopid: Option[String], payonlinekey: Option[String], payonlinerate: Option[scala.math.BigDecimal] = Some(scala.math.BigDecimal("0")), payonlinepluspoundage: Option[Boolean], prefixOrderformnum: Option[String], prefixPaymentnum: Option[String], country: Option[String], province: Option[String], city: Option[String], postcode: Option[String], messageoforderconfirm: Option[String], emailoforderconfirm: Option[String], messageofsendcard: Option[String], emailofsendcard: Option[String], messageofreceiptmoney: Option[String], emailofreceiptmoney: Option[String], messageofrefund: Option[String], emailofrefund: Option[String], messageofinvoice: Option[String], emailofinvoice: Option[String], messageofdeliver: Option[String], emailofdeliver: Option[String], guestbookEnablevisitor: Boolean, guestbookcheck: Boolean, guestbookEnablemanagerubbish: Boolean, guestbookManagerubbish: Option[String], guestbookShowip: Boolean, guestbookIsassignsort: Boolean, guestbookMaxperpage: Option[String], enablerss: Boolean, rsscodetype: Option[Boolean], enablewap: Boolean, waplogo: Option[String], enablewappl: Boolean, showwapappendix: Boolean, showwapshop: Option[Boolean], showwapmanage: Option[Boolean], databaseversion: Option[Double] = Some(0.0), timingSetdate: Option[Int] = Some(0), timingSetday: Option[Int] = Some(0), timingSetweekday: Option[Int] = Some(0), timingTime: Option[String], timingDate: Option[java.sql.Timestamp], timingCollectionitemid: Option[String], timingAreacollection: Option[String], timingBreakpoint: Option[String], iscustomContent: Option[Boolean], smsusername: Option[String], smskey: Option[String], mobiles: Option[String], sendmessagetoadminwhenorder: Option[Boolean], sendmessagetomemberwhenpaysuccess: Option[Boolean], surveykey: Option[String], messageoforder: Option[String], messageofaddremit: Option[String], messageofaddincome: Option[String], messageofaddpayment: Option[String], messageofexchangepoint: Option[String], messageofaddpoint: Option[String], messageofminuspoint: Option[String], messageofexchangevalid: Option[String], messageofaddvalid: Option[String], messageofminusvalid: Option[String], thumbBackgroundcolor: Option[String], photoquality: Option[Int], showusermodel: Option[Boolean], showanonymous: Option[Boolean])
