...
trait PeFieldTable {
  ...
  case class PeFieldRow(
    ...
    tips: Option[String],
    fieldtype: Option[Int] = Some(0),
    defaultvalue: Option[String],
    options: Option[String],
    enablenull: Option[Boolean],
    showonform: Option[Boolean],
    fieldlevel: Option[Int] = Some(0)
  )
  ...
  class PeField(_tableTag: Tag) extends profile.api.Table[PeFieldRow](_tableTag, "PE_Field") {
    def * =
      (fieldid :: channelid :: fieldname :: title :: labelname :: tips :: fieldtype :: defaultvalue :: options :: enablenull :: showonform :: fieldlevel :: HNil)
        .mapTo[PeFieldRow]
