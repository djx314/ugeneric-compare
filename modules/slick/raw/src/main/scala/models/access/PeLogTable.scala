...
trait PeLogTable {
  ...
  class PeLog(_tableTag: Tag) extends profile.api.Table[PeLogRow](_tableTag, "PE_Log") {
    def * = (logid :: logtype :: channelid :: logtime :: username :: userip :: logcontent :: scriptname :: poststring :: HNil).mapTo[PeLogRow]
    ...
    val index1 = index("PE_LOG_CHANNELID", channelid :: HNil)
  }
