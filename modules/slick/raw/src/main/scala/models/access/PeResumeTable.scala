...
trait PeResumeTable {
  ...
  case class PeResumeRow(
    resumeid: Int = 0,
    intervieweename: Option[String],
    username: Option[String],
    nationality: Option[String],
    politicalfeature: Option[String],
    age: Option[Int] = Some(0),
    height: Option[String],
    weight: Option[String],
    sex: Option[Int] = Some(0),
    photo: Option[String],
    marital: Option[Int] = Some(0),
    health: Option[String],
    birthplace: Option[String],
    currentaddress: Option[String],
    qq: Option[String],
    telephone: Option[String],
    mobilephone: Option[String],
    address: Option[String],
    eMail: Option[String],
    graduateschool: Option[String],
    education: Option[Int] = Some(0),
    profession: Option[String],
    availabledate: Option[String],
    workexperience: Option[String],
    professionalability: Option[String],
    foreignlanguagekind: Option[Int] = Some(0),
    foreignlanguageleval: Option[String],
    motherlanguageleval: Option[String],
    otherlanguageleval: Option[String]
  )
  ...
  class PeResume(_tableTag: Tag) extends profile.api.Table[PeResumeRow](_tableTag, "PE_Resume") {
    def * =
      (resumeid :: intervieweename :: username :: nationality :: politicalfeature :: age :: height :: weight :: sex :: photo :: marital :: health :: birthplace :: currentaddress :: qq :: telephone :: mobilephone :: address :: eMail :: graduateschool :: education :: profession :: availabledate :: workexperience :: professionalability :: foreignlanguagekind :: foreignlanguageleval :: motherlanguageleval :: otherlanguageleval :: HNil)
        .mapTo[PeResumeRow]
