...
trait PeUseddetailTable {
  ...
  case class PeUseddetailRow(
    id: Int,
    equipmentid: Option[Int] = Some(0),
    username: Option[String],
    usertype: Option[Int] = Some(0),
    useryear: Option[Int],
    userclass: Option[String],
    lessoninfo: Option[String],
    lessonnumber: Option[Int],
    lessonyear: Option[Int] = Some(0),
    lessonmonth: Option[Int] = Some(0),
    lessonday: Option[Int] = Some(0),
    registertime: Option[java.sql.Timestamp],
    registerip: Option[String],
    used: Option[Int] = Some(0)
  )
  ...
  class PeUseddetail(_tableTag: Tag) extends profile.api.Table[PeUseddetailRow](_tableTag, "PE_UsedDetail") {
    def * =
      (id :: equipmentid :: username :: usertype :: useryear :: userclass :: lessoninfo :: lessonnumber :: lessonyear :: lessonmonth :: lessonday :: registertime :: registerip :: used :: HNil)
        .mapTo[PeUseddetailRow]
    ...
    val index1 = index("PE_USEDDETAIL_FACILITYNUM", equipmentid :: HNil)

    /** Index over (lessonnumber) (database name PE_USEDDETAIL_LESSIONNUM) */
    val index2 = index("PE_USEDDETAIL_LESSIONNUM", lessonnumber :: HNil)
  }
