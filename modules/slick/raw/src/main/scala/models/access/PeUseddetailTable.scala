...
trait PeUseddetailTable {
  ...
  class PeUseddetail(_tableTag: Tag) extends profile.api.Table[PeUseddetailRow](_tableTag, "PE_UsedDetail") {
    def * = (id :: equipmentid :: username :: usertype :: useryear :: userclass :: lessoninfo :: lessonnumber :: lessonyear :: lessonmonth :: lessonday :: registertime :: registerip :: used :: HNil).mapTo[PeUseddetailRow]
