...
trait PeCompanyTable {
  ...
  case class PeCompanyRow(
    ...
    bankofdeposit: Option[String],
    bankaccount: Option[String],
    taxnum: Option[String],
    statusinfield: Option[Int] = Some(0),
    companysize: Option[Int] = Some(0),
    businessscope: Option[String],
    annualsales: Option[String],
    managementforms: Option[Int] = Some(0),
    registeredcapital: Option[String],
    companyintro: Option[String],
    compamypic: Option[String]
  )
  ...
  class PeCompany(_tableTag: Tag) extends profile.api.Table[PeCompanyRow](_tableTag, "PE_Company") {
    def * =
      (companyid :: clientid :: companyname :: country :: province :: city :: address :: zipcode :: phone :: fax :: homepage :: bankofdeposit :: bankaccount :: taxnum :: statusinfield :: companysize :: businessscope :: annualsales :: managementforms :: registeredcapital :: companyintro :: compamypic :: HNil)
        .mapTo[PeCompanyRow]
    ...
    val index1 = index("PE_COMPANY_CLIENTID", clientid :: HNil)

    /** Index over (taxnum) (database name PE_COMPANY_TAXNUM) */
    val index2 = index("PE_COMPANY_TAXNUM", taxnum :: HNil)

    /** Index over (zipcode) (database name PE_COMPANY_ZIPCODE) */
    val index3 = index("PE_COMPANY_ZIPCODE", zipcode :: HNil)
  }
