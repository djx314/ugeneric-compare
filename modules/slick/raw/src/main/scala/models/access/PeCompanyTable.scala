...
trait PeCompanyTable {
  ...
  class PeCompany(_tableTag: Tag) extends profile.api.Table[PeCompanyRow](_tableTag, "PE_Company") {
    def * = (companyid :: clientid :: companyname :: country :: province :: city :: address :: zipcode :: phone :: fax :: homepage :: bankofdeposit :: bankaccount :: taxnum :: statusinfield :: companysize :: businessscope :: annualsales :: managementforms :: registeredcapital :: companyintro :: compamypic :: HNil).mapTo[PeCompanyRow]
