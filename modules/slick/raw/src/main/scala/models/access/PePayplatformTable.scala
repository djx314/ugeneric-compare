...
trait PePayplatformTable {
  ...
  class PePayplatform(_tableTag: Tag) extends profile.api.Table[PePayplatformRow](_tableTag, "PE_PayPlatform") {
    def * =
      (platformid :: platformname :: showname :: description :: accountsid :: rate :: pluspoundage :: orderid :: isdisabled :: isdefault :: md5key :: HNil)
        .mapTo[PePayplatformRow]
