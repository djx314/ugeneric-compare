...
trait PeAdminTable {
  ...
  case class PeAdminRow(id: Int, adminname: Option[String], username: String, password: String, purview: Int, rolename: Option[String], lastloginip: Option[String], lastlogintime: Option[java.sql.Timestamp], lastlogouttime: Option[java.sql.Timestamp], logintimes: Option[Int] = Some(0), rndpassword: Option[String], enablemultilogin: Boolean, adminpurviewArticle: Option[Int] = Some(0), adminpurviewSoft: Option[Int] = Some(0), adminpurviewPhoto: Option[Int] = Some(0), adminpurviewGuestbook: Option[Int] = Some(0), adminpurviewSupply: Option[Int], adminpurviewHouse: Option[Int] = Some(0), adminpurviewJob: Option[Int], adminpurviewShop: Option[Int] = Some(0), adminpurviewOthers: Option[String], arrclassView: Option[String], arrclassInput: Option[String], arrclassCheck: Option[String], arrclassManage: Option[String], arrclassHouse: Option[String], arrclassGuestbook: Option[String], countAdd: Option[Int] = Some(0), countCheck: Option[Int] = Some(0), countReject: Option[Int] = Some(0))
  ...
  class PeAdmin(_tableTag: Tag) extends profile.api.Table[PeAdminRow](_tableTag, "PE_Admin") {
    def * = (id :: adminname :: username :: password :: purview :: rolename :: lastloginip :: lastlogintime :: lastlogouttime :: logintimes :: rndpassword :: enablemultilogin :: adminpurviewArticle :: adminpurviewSoft :: adminpurviewPhoto :: adminpurviewGuestbook :: adminpurviewSupply :: adminpurviewHouse :: adminpurviewJob :: adminpurviewShop :: adminpurviewOthers :: arrclassView :: arrclassInput :: arrclassCheck :: arrclassManage :: arrclassHouse :: arrclassGuestbook :: countAdd :: countCheck :: countReject :: HNil).mapTo[PeAdminRow]
    ...
    val index1 = index("PE_ADMIN_PASSWORD", password :: HNil)
    /** Index over (username) (database name PE_ADMIN_USERNAME) */
    val index2 = index("PE_ADMIN_USERNAME", username :: HNil)
  }
