...
trait PeAuthorTable {
  ...
  case class PeAuthorRow(
    id: Int,
    channelid: Option[Short] = Some(0),
    authorname: String,
    sex: Option[Short] = Some(0),
    ...
    authortype: Option[Short] = Some(0),
  ...
  class PeAuthor(_tableTag: Tag) extends profile.api.Table[PeAuthorRow](_tableTag, "PE_Author") {
    def * =
      (id :: channelid :: authorname :: sex :: birthday :: photo :: intro :: address :: tel :: fax :: company :: department :: zipcode :: homepage :: email :: qq :: authortype :: lastusetime :: passed :: iselite :: ontop :: hits :: templateid :: HNil)
        .mapTo[PeAuthorRow]
